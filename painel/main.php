<?php
  //$pdo = new PDO('mysql:host=localhost;dbname=bootstrap_painel','root','');
    ...
    <nav class="navbar navbar-fixed-top navbar-default">
      <div class="container">
        <div class="navbar-header">
          ...
          <a class="navbar-brand" href="#">Bite.Code</a>
        </div>
        <div id="navbar" class="collapse navbar-collapse">
          ...
          <ul class="nav navbar-nav navbar-right">
            <li><a href="<?php echo INCLUDE_PATH_PAINEL ?>?loggout"><span class="glyphicon glyphicon-off"></span> Sair!</a></li>
          </ul>
        </div><!--/.nav-collapse -->
      </div>
    </nav>
            ...
            <div class="row">
                ...
                <?php
                  if(isset($_POST['editar_sobre'])){
                    $sobre = $_POST['sobre'];
                    $sql = MySql::conectar()->prepare("DELETE FROM `tb_sobre`");
                    $sql->execute();
                    $sql = MySql::conectar()->prepare("INSERT INTO `tb_sobre` VALUES (null,?)");
                      ...
                      <div id="lista_equipe_section" class="panel panel-default">
                          ...
                          <div class="panel-body">
                            <table class="table">
                              ...
                              <tbody>
                                <?php
                                    $sql = MySql::conectar()->prepare("SELECT `id`,`nome` FROM `tb_equipe`");
                                    $sql->execute();
                                    $sql = $sql->fetchAll();
                                ...
                                <tr>
                                  ...
                                  <td><button id_membro="<?php echo $value['id']['nome']; ?>" type="button" class="deletar-membro btn btn-sm btn-danger"><span class="glyphicon glyphicon-trash"></span> Excluir</button></td>
                                </tr>
